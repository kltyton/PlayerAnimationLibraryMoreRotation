...
- Player Animation Library Fabric / Neo: `1.0.12+mc.1.21.8`
- bendable-cuboids: `1.0.5`
- Java: `21`
...
dependencies {
    modImplementation "com.kltyton:playeranimationlibrarymorerotation-fabric-1.21.7:1.1.0"
    // 或：
    implementation "com.kltyton:playeranimationlibrarymorerotation-neoforge-1.21.7:1.1.0"
}
```
