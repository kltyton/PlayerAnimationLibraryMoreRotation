...
dependencies {
    modImplementation "com.kltyton:playeranimationlibrarymorerotation-fabric-26.1:1.1.0"
    // 或：
    implementation "com.kltyton:playeranimationlibrarymorerotation-neoforge-26.1:1.1.0"
}
```
