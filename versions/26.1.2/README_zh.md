...
- NeoForge: `26.1.2.109`
- Player Animation Library Fabric / Neo: `1.2.6+mc.26.1`
...
dependencies {
    modImplementation "com.kltyton:playeranimationlibrarymorerotation-fabric-26.1.2:1.1.0"
    // 或：
    implementation "com.kltyton:playeranimationlibrarymorerotation-neoforge-26.1.2:1.1.0"
}
```
