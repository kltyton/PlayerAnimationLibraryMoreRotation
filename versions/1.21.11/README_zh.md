...
- NeoForge: `21.11.45`
- Player Animation Library Fabric / Neo: `1.1.10+mc.1.21.11`
- bendable-cuboids: `2.0.1`
- Java: `21`
...
dependencies {
    modImplementation "com.kltyton:playeranimationlibrarymorerotation-fabric-1.21.11:1.1.0"
    // 或：
    implementation "com.kltyton:playeranimationlibrarymorerotation-neoforge-1.21.11:1.1.0"
}
```
