...
- NeoForge: `21.8.54`
- Player Animation Library Fabric / Neo: `1.1.2+mc.1.21.8`
...
dependencies {
    modImplementation "com.kltyton:playeranimationlibrarymorerotation-fabric-1.21.8:1.1.0"
    // 或：
    implementation "com.kltyton:playeranimationlibrarymorerotation-neoforge-1.21.8:1.1.0"
}
```
