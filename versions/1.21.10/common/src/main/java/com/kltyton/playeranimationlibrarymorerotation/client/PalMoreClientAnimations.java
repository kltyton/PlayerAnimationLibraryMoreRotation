...
public final class PalMoreClientAnimations {
    ...
    public static boolean playLocal(Avatar avatar, ResourceLocation animationId) {
        return playLocal(avatar, animationId, PalMoreFirstPersonOptions.DISABLED);
    }

    public static boolean playLocal(Avatar avatar, ResourceLocation animationId, PalMoreFirstPersonOptions firstPersonOptions) {
    ...
    public static PalMoreAnimationController playLocal(Avatar avatar, ResourceLocation animationId, ResourceLocation controllerId) {
