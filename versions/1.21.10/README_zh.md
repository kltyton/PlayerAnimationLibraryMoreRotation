...
- NeoForge: `21.10.64`
- Player Animation Library Fabric / Neo: `1.1.3+mc.1.21.9`
- bendable-cuboids: `1.0.7`
- Java: `21`
...
dependencies {
    modImplementation "com.kltyton:playeranimationlibrarymorerotation-fabric-1.21.10:1.1.0"
    // 或：
    implementation "com.kltyton:playeranimationlibrarymorerotation-neoforge-1.21.10:1.1.0"
}
```
